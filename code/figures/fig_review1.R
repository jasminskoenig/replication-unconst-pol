...
ggsave("results/fig_review1.pdf",width=18,height=10, units = "cm", device = cairo_pdf)  
ggsave("results/fig_review1.tiff",width=18,height=10, units = "cm",compression = "lzw", dpi = 400)
